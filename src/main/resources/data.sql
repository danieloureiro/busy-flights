...
INSERT INTO crazy_air_flight (id, departure_date, arrival_date, airline, price, cabin_class, departure_airport_code, destination_airport_code, number_of_passengers) values (2, current_timestamp(), current_timestamp(), 'Ryanair', 35.99, 'E', 'OPO', 'STN', 2);
...
INSERT INTO tough_jet_flight (id, outbound_date_time, inbound_date_time, carrier, base_price, tax, discount, departure_airport_name, arrival_airport_name, number_of_adults) values (2, current_timestamp(), current_timestamp(), 'Ryanair', 55.99, 3.5, 20.0, 'OPO', 'STN', 2);
